"""
URL configuration for LockLite project.
...
urlpatterns = [
	...
	# path('password-reset/', auth_views.PasswordResetView.as_view(template_name='password_reset.jinja',html_email_template_name='password_reset_email.jinja'),name='password-reset'),
	# path('password-reset/done/', auth_views.PasswordResetDoneView.as_view(template_name='password_reset_done.jinja', ), name='password-reset-done'),
